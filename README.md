...
|Personal-expenses tracker app| A python built expenses tracker app, where you can store your add expenses, filter, search, delete,import. this is built with python' tkinter, sqlite, csv. |
